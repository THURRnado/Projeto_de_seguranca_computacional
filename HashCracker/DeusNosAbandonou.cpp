...
void Tomie(std::vector<std::string>& dictionary, std::string hash, std::string salt, std::string hash_type, int thread_count, bool haveSalt) {



    ThreadPool MachadoDeAssis(thread_count);
